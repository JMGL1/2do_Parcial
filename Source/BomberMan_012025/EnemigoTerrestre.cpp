...
AEnemigoTerrestre::AEnemigoTerrestre()
{
	...
	{
		static ConstructorHelpers::FObjectFinder<UMaterial> MaterialBaseAsset(TEXT("/Script/Engine.Material'/Game/StarterContent/Materials/M_Ground_Grass.M_Ground_Grass'")); // Ruta al material.
