...
AEnemigoAereo::AEnemigoAereo()
{
	...
	{
		static ConstructorHelpers::FObjectFinder<UMaterial> MaterialBaseAsset(TEXT("/Script/Engine.Material'/Game/StarterContent/Materials/M_Water_Lake.M_Water_Lake'")); // Ruta al material.
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh> MallaTerrestreAsset(TEXT("/Script/Engine.StaticMesh'/Game/StarterContent/Shapes/Shape_Cylinder.Shape_Cylinder'")); // Ruta a la malla.
