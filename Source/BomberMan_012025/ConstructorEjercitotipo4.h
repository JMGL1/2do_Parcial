...
#include "ConstructorEjercitotipo4.generated.h"
class AEnemigoTerrestre; class AEnemigoAereo; class AEnemigoGigante;
UCLASS()
class BOMBERMAN_012025_API AConstructorEjercitotipo4 : public AActor, public IConstructorEjercito2
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AConstructorEjercitotipo4();
